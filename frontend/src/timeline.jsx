...
function TimeLine() {
    ...
    if (i18n.language === "en" || i18n.language === "zh") {
        const { s_conpanyName, s_timeRange, s_p1, s_p2, s_p3 } = t("companyList.sjm");
        const { f_conpanyName, f_timeRange, f_p1, f_p2 } = t("companyList.fhia");
        const { a_conpanyName, a_timeRange, a_p1, a_p2 } = t("companyList.autoEdit");
        return (
            <All>
                <Timeline>
                    {/* 1 */}
